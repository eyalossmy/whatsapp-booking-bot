...
async function notifyBusinessOwner(business, appointment, customerPhone) {
  ...
  // Get customer name from appointment or use phone
...
6. רק אחרי אישור - תכתוב "CONFIRM:[זמן בפורמט ISO]|NAME:[שם הלקוח]"

דוגמה לפלט:
"שלום! שמח לעזור. איך קוראים לך?"
[לקוח: "איל"]
"נעים מאוד איל! באיזה יום אתה מעוניין בתור?"

אחרי אישור של הלקוח:
"CONFIRM:2026-02-18T14:00:00|NAME:איל"
