...
תשובתך (קצרה ומדויקת):`;
    ...
    if (lowerMessage.includes('תור') || lowerMessage.includes('קביעה')) {
      return 'שלום! אשמח לעזור לך לקבוע תור. באיזה יום נוח לך?';
    }
    
    if (lowerMessage.includes('שלום') || lowerMessage.includes('היי') || lowerMessage.includes('הי')) {
      return 'שלום! איך אוכל לעזור לך? אפשר לקבוע תור או לבדוק זמינות.';
    }
    
    return 'שלום! אני כאן לעזור לך לקבוע תור. כתוב "אני רוצה תור" ונתחיל!';
  }
}
